...
8. ERR messages start with ␇ (\u0007) bel control and end with ␃ (\u0003) end-text control.
9. JSON Messages start with ␂ (\u0002) start-text control and end with ␃ (\u0003) end-text control.
   1. JSON messages are ALWAYS objects.
10. Non-JSON message transmissions are specified with the ␎ (\u000E) shift-out control:
